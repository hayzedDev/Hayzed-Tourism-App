      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.message); // alert(err.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGF5emVkZGV2IiwiYSI6ImNsMWZhZzl5NDAwczEzY21wdXpjZmxuYTgifQ.hRyzZTnbs0eiiHfgIt5OWw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/hayzeddev/cl1g6m18200n414qol9dfgejc',
    // style URL
    center: [3.3792057, 6.5243793],
    // starting position [lng, lat]
    scrollZoom: false // zoom: 10, // starting zoom
    // interactive: false,
...
},{}],"upateSettings.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _stripeJs.loadStripe)('pk_test_51KmAGYLnqQtGiopwMphGVnhuV3ivrS8rHYKcWGsMh4U5VVuNZy7zSOfvpxSXNEc7YJVUWXgJpT5xb55KAHR8JE2T00plAahiYW');
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js","axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"forgotPasswordClient.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetPasswordClient = exports.forgotPasswordClient = void 0;
...
var forgotPasswordClient = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Email successfully sent! Please check your inbox on how to reset your password.');
              window.setTimeout(function () {
                location.assign('/');
              }, 5000);
            }
  ...
  return function forgotPasswordClient(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var resetPasswordClient = /*#__PURE__*/function () {
  ...
  return function resetPasswordClient(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.resetPasswordClient = resetPasswordClient;
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, pass, passConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Account Created! Please Check your Inbox On How To Get Started.'); // alert('Logged in successfully!');
...
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _forgotPasswordClient = require("./forgotPasswordClient");
...
var loginBtn = document.querySelector('.form--login-btn');
var signupBtn = document.querySelector('.btn--sign-up');
var forgotPasswordBtn = document.querySelector('.btn--forgot-password');
var resetPassword = document.querySelector('.reset--my-password');
var sendEmail = document.querySelector('.btn--send--forgetPassword--email');
var userPasswordBtn = document.querySelector('.form-user-settings');
var mapBox = document.getElementById('map');
var logoutBtn = document.querySelector('.nav__el--logout');
var nameInput = document.getElementById('name');
var emailInput = document.getElementById('email');
var photoInput = document.getElementById('photo');
var oldPasswordEl = document.getElementById('password-current');
var newPasswordEl = document.getElementById('password');
var newPasswordConfirmEl = document.getElementById('password-confirm');
var btnSavePassword = document.querySelector('.btn-save--password');
var booking = document.getElementById('book-tour'); // Delegation
...
if (loginBtn) {
  loginBtn.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var loginButton, email, password;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              loginButton = document.querySelector('.btn--green');
...
if (sendEmail) sendEmail.addEventListener('click', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return (0, _forgotPasswordClient.forgotPasswordClient)(email);
...
if (userData) userData.addEventListener('submit', function (e) {
  ...
  (0, _upateSettings.updateUserSettings)(form, 'name, email & photo'); // updateUserSettings({ name, email }, 'name & email');
});
if (userPasswordBtn) userPasswordBtn.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            newPasswordConfirm = newPasswordConfirmEl.value;
            _context3.next = 7;
            return (0, _upateSettings.updateUserSettings)({
          ...
          case 7:
            [oldPassword, newPassword, newPassword].forEach(function (el) {
              return el = '';
            });
...
if (booking) booking.addEventListener('click', function (e) {
  e.preventDefault();
  e.target.textContent = 'Processing...';
  var tourId = booking.dataset.tourId;
  (0, _stripe.bookTour)(tourId);
});
if (resetPassword) resetPassword.addEventListener('click', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var passResetField, passResetConfirmField, token;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            passResetField = document.querySelector('.password--reset');
            passResetConfirmField = document.querySelector('.password--reset--confirm');
            token = window.location.pathname.split('/').at(2);
            _context4.next = 7;
            return (0, _forgotPasswordClient.resetPasswordClient)(passResetField.value, passResetConfirmField.value, token);
...
if (signupBtn) signupBtn.addEventListener('click', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            name = document.querySelector('.form__input--signup-name');
            email = document.querySelector('.form__input--email--signup');
            password = document.getElementById('passwordSignup');
            passwordConfirm = document.getElementById('passwordSignupConfirm');
            _context5.next = 8;
            return (0, _signup.signup)(name.value, email.value, password.value, passwordConfirm.value);
